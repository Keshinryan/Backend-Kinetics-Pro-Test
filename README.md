# Backend Kinetics Pro Test Project
...
1. **Clone the Repository**
   ...
   ```bash
   git clone https://github.com/Keshinryan/Backend-Kinetics-Pro-Test
   ```
   
2. **Navigate to the Project Directory**

    ```bash
    cd Backend-Kinetics-Pro-Test
    ```
...
## API Reference
- Repository : <a href=" https://github.com/Keshinryan/Frontend-Kinetics-Pro-Test" >Frontend Repo</a>
